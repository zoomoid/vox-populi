...
// The ReactionTemplateFunc type is an adapter to allow the use of ordinary
// function as ReactionTemplate mutator.
type ReactionTemplateFunc func(context.Context, *ent.ReactionTemplateMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ReactionTemplateFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.ReactionTemplateMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ReactionTemplateMutation", m)
	}
	return f(ctx, mv)
}
...
// The VoteTemplateFunc type is an adapter to allow the use of ordinary
// function as VoteTemplate mutator.
type VoteTemplateFunc func(context.Context, *ent.VoteTemplateMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VoteTemplateFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.VoteTemplateMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VoteTemplateMutation", m)
	}
	return f(ctx, mv)
}
